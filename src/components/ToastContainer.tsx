// ============================================
// CLUB 90 — Toast Notification System
// ============================================
      ...
      {toasts.map((toast) => (
        <div
          ...
          className={`pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-xl shadow-2xl border transition-all duration-300 animate-[slideDown_0.3s_ease-out] ${
            toast.type === 'success'
              ? 'bg-[#1a2c39] border-[#00e601]/30 text-[#77ff61]'
              : toast.type === 'error'
              ? 'bg-[#1a2c39] border-[#ffb4ab]/30 text-[#ffb4ab]'
              : 'bg-[#1a2c39] border-[#aac7ff]/30 text-[#aac7ff]'
          }`}
        >
          ...
          <button
            ...
            className="text-[#c1c6d5] hover:text-white transition-colors ml-2"
          >
